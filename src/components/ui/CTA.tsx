...
const Icons = {
  ...
  openai: () => <Sparkle width="100" height="100" fill="black" />,
  googleDrive: () => (
    <svg
      width="100"
      height="100"
...
const CTA = () => {
  return (
    <div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative bg-card/50">
